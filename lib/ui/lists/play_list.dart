...
List playItems = [
  ItemsEntity(
      ...
      id: 2,
      spot: 101,
      image: 'assets/images/машинка.jpg',
      audio: 'assets/audio/машинка.mp3'),
  ItemsEntity(
      text: 'Паровоз',
      id: 2,
      spot: 102,
      image: 'assets/images/паровоз.jpg',
      audio: 'assets/audio/паровоз.mp3'),
  ItemsEntity(
      text: 'Телевизор',
      id: 2,
      spot: 103,
      image: 'assets/images/телевизор.jpeg',
      audio: 'assets/audio/телевизор.mp3'),
  ItemsEntity(
      text: 'Паззл',
      id: 2,
      spot: 104,
      image: 'assets/images/паззл.png',
      audio: 'assets/audio/паззл.mp3'),
  ItemsEntity(
      text: 'Компьютер',
      id: 2,
      spot: 105,
      image: 'assets/images/компьютер.webp',
      audio: 'assets/audio/компьютер.mp3'),
  ItemsEntity(
      text: 'Пластилин',
      id: 2,
      spot: 106,
      image: 'assets/images/пластилин.jpeg',
      audio: 'assets/audio/пластилин.mp3'),
...
class _PlayListState extends State<PlayList>
  ...
  void initState() {
    ...
    // if (isFirstRunForPlay == false) {}
    // isFirstRunForPlay = true;

    // PlayBox.getTransactions().clear();
  }

  final transaction1 =
      PlayBox.getTransactions().values.toList().cast<ItemsEntity>();
                ...
                children: [
                  Padding(
                      ...
                      child: ValueListenableBuilder(
                          valueListenable:
                              PlayBox.getTransactions().listenable(),
                          builder: (context, Box<ItemsEntity> box, _) {
                            final transactions = PlayBox.getTransactions()
                                .values
                                .toList()
                                .cast<ItemsEntity>();
