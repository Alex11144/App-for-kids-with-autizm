...
List restItems = [
  ItemsEntity(
      ...
      id: 2,
      spot: 601,
      image: 'assets/images/перемена.jpg',
      audio: 'assets/audio/перемена.mp3'),
  ItemsEntity(
      text: 'Спать',
      id: 2,
      spot: 602,
      image: 'assets/images/спать.jpg',
      audio: 'assets/audio/спать.mp3'),
  ItemsEntity(
      text: '',
      id: 1000,
      spot: 700,
...
class _RestListState extends State<RestList>
  ...
  void initState() {
    ...
    // if (isFirstRunForRest == false) {}
    // isFirstRunForRest = true;

    // RestBox.getTransactions().clear();
  }

  int currentIndex1 = 0;

  final transaction1 =
      RestBox.getTransactions().values.toList().cast<ItemsEntity>();
                ...
                children: [
                  Padding(
                      ...
                      child: ValueListenableBuilder(
                          valueListenable:
                              RestBox.getTransactions().listenable(),
                          builder: (context, Box<ItemsEntity> box, _) {
                            final transactions1 = RestBox.getTransactions()
                                .values
                                .toList()
                                .cast<ItemsEntity>();
