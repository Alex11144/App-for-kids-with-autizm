...
import '../bottom_bar_with_items/bottom_bar.dart';

// List items2 = [
//   ItemsEntity(text: 'Мясо', id: 2, spot: 11, image: 'assets/images/мясо.jpg'),
//   ItemsEntity(text: 'Рис', id: 2, spot: 12, image: 'assets/images/рис.jpg'),
//   ItemsEntity(text: 'Овощи', id: 2, spot: 13, image: 'assets/images/овощи.jpg'),
//   ItemsEntity(
//       text: 'Выпечка', id: 2, spot: 14, image: 'assets/images/выпечка.jpeg'),
//   ItemsEntity(
//       text: 'Гречка',
//       id: 2,
//       spot: 15,
...
//   ItemsEntity(
//       text: 'Макароны', id: 2, spot: 16, image: 'assets/images/есть.jpg'),
//   ItemsEntity(
//       text: 'Фрукты', id: 2, spot: 17, image: 'assets/images/фрукты.webp'),
//   ItemsEntity(
//       text: 'Сладкое', id: 2, spot: 18, image: 'assets/images/сладкое.jpg'),
//   ItemsEntity(
//       text: '', id: 1000, spot: 100, image: 'assets/images/сладкое.jpg'),
//   // ItemsEntity(
//   //   text: '',
//   //   id: 1000,
//   //   spot: 20,
...
class _MyCardsState extends State<MyCards> with SingleTickerProviderStateMixin {
  ...
  var items = MyCardsBox.getTransactions().values.toList();
  int currentIndex1 = 0;
  ...
  final transaction =
      MyCardsBox.getTransactions().values.toList().cast<ItemsEntity>();
                ...
                children: [
                  Padding(
                      ...
                      child: ValueListenableBuilder(
                          valueListenable:
                              MyCardsBox.getTransactions().listenable(),
                          builder: (context, Box<ItemsEntity> box, _) {
                            final transactions = MyCardsBox.getTransactions()
                                .values
                                .toList()
                                .cast<ItemsEntity>();
